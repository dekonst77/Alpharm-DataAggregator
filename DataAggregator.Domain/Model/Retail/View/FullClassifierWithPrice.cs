...
{
    [Table("FullClassifierWithPrice", Schema = "calc")]
    public class FullClassifierWithPrice
    {
        ...
        public long? OwnerTradeMarkCorporationId { get; set; }
        public string OwnerTradeMarkCorporation { get; set; }
        ...
        public int? DV2015 { get; set; }
        public int? DV2016 { get; set; }
        public int? DV2017 { get; set; }
        public int? DV2018 { get; set; }
