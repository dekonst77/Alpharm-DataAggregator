...
namespace DataAggregator.Web.Managers
{
    public class Impersonator : IDisposable
    {
        ...
        public Impersonator(string username, string password, string userDomain = "")
        {
            _userHandle = new IntPtr(0);
            bool returnValue = LogonUser(username, userDomain, password, LOGON32_LOGON_NEW_CREDENTIALS, LOGON32_PROVIDER_DEFAULT,
                                         ref _userHandle);
            if (!returnValue)
