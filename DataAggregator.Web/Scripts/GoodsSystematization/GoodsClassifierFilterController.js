angular
    ...
    .controller('GoodsClassifierFilterController', ['$scope', '$http', '$uibModalInstance', 'hotkeys', 'classifierFilter', GoodsClassifierFilterController]);

function GoodsClassifierFilterController($scope, $http, $modalInstance, hotkeys, classifierFilter) {
    ...
    $scope.CanSearch = function () {
        for (var i in $scope.classifierFilter) {
            if ($scope.classifierFilter.hasOwnProperty(i)) {
