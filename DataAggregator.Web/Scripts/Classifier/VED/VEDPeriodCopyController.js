angular
    ...
    .controller('VEDPeriodCopyController', ['$scope', '$uibModalInstance', '$http', 'messageBoxService', 'data', 'uiGridCustomService', 'formatConstants', VEDPeriodCopyController]);

function VEDPeriodCopyController($scope, $modalInstance, $http, messageBoxService, data, uiGridCustomService, formatConstants) {

    //Задаем свойства грида
    $scope.gridPeriodOptions = uiGridCustomService.createOptions('Ved_PeriodCopyGrid');
