angular
    ...
    .controller('ATCBaaController', ['$scope', '$http', 'messageBoxService', 'uiGridCustomService', ATCBaaController]);

function ATCBaaController($scope, $http, messageBoxService, uiGridCustomService) {
    ...
    $scope.gridOptions = uiGridCustomService.createOptions('ATCBaa_Grid');
