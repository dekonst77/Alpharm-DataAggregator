angular
    ...
    .controller('GoodsClassifierEditorFilterController', ['$scope', '$http', '$uibModalInstance', 'hotkeys', 'classifierFilter', 'goodsCategoryList', GoodsClassifierEditorFilterController]);

function GoodsClassifierEditorFilterController($scope, $http, $modalInstance, hotkeys, classifierFilter, goodsCategoryList) {
    ...
    $scope.goodsCategoryList = goodsCategoryList;
