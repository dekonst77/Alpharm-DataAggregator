angular
    ...
    .controller('TransferRuleController', ['$scope', '$http', '$uibModalInstance', 'model', '$translate', TransferRuleController]);

function TransferRuleController($scope, $http, $modalInstance, model, $translate) {
    ...
    $scope.copyRule = function() {
        ...
        $scope.loading = $http.post('/CountRuleEditor/SaveRow', JSON.stringify({ model: ruleForSave }))
            .then(function(response) {
