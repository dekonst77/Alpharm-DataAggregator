angular
    ...
    .controller('SearchRawDataByClassifierController', ['$scope', '$http', 'uiGridCustomService', '$translate', 'uiGridConstants', 'formatConstants', SearchRawDataByClassifierController]);

function SearchRawDataByClassifierController($scope, $http, uiGridCustomService, $translate, uiGridConstants, formatConstants) {
    ...
    [
        ...
        { Id: 2, Name: $translate.instant('DOP') }
    ];
    ...
    $scope.rawDataByClassifierGrid = {
        options: uiGridCustomService.createOptions('SearchRawDataByClassifier_RawDataByClassifierGrid')
    };
    ...
    $scope.search = function () {
        ...
        $scope.loading = $http.post('/SearchRawDataByClassifier/GetData', JSON.stringify(data)).then(function(response) {
    ...
    function searchTradeName(value) {
        var httpPromise = $http.post('/TradeName/SearchTradeName/', JSON.stringify({ Value: value }))
            .then(function (response) {
    ...
    function searchBrand(value) {
        var httpPromise = $http.post('/Brand/SearchBrand/', JSON.stringify({ Value: value }))
            .then(function (response) {
    ...
    function searchClassifier(value) {
        var httpPromise = $http.post('/ExternalViewAllPeriod/SearchExternalViewAllPeriod/', JSON.stringify({ Value: value }))
            .then(function(response) {
