...
function SalesSKUBySFController($scope, $http, $q, $cacheFactory, $filter, $timeout, userService, uiGridCustomService, errorHandlerService, messageBoxService, uiGridConstants, formatConstants, uiGridPaginationService) {
    ...
    $scope.SalesSKUbySF_Init = function () {
        ...
        $scope.Grid.Options.columnDefs = [
            ...
            { headerTooltip: true, cellTooltip: true, enableCellEdit: false, width: 150, name: 'Выручка на 1 аптеку ОФД', field: 'RevenuePerOFDpharmacy', visible: true, headerCellClass: 'Revenue', filter: { condition: uiGridCustomService.condition }, cellTemplate: numbercellTemplateHint },
            { headerTooltip: true, cellTooltip: true, enableCellEdit: false, width: 150, name: 'Выручка на 1 аптеку АЛБ', field: 'RevenuePerALBpharmacy', visible: true, headerCellClass: 'Revenue', filter: { condition: uiGridCustomService.condition }, cellTemplate: numbercellTemplateHint },
            { headerTooltip: true, cellTooltip: true, enableCellEdit: false, width: 150, name: 'Доля от рынка в регионе ОФД', field: 'MarketShareinOFDRegion', visible: true, headerCellClass: 'Revenue', filter: { condition: uiGridCustomService.condition }, cellTemplate: numbercellTemplateHint },
            { headerTooltip: true, cellTooltip: true, enableCellEdit: false, width: 150, name: 'Доля от рынка в регионе АЛБ', field: 'MarketShareinALBRegion', visible: true, headerCellClass: 'Revenue', filter: { condition: uiGridCustomService.condition }, cellTemplate: numbercellTemplateHint },
