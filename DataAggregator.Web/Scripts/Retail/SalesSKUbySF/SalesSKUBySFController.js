...
function SalesSKUBySFController($scope, $http, $q, $cacheFactory, $filter, $timeout, userService, uiGridCustomService, errorHandlerService, messageBoxService, uiGridConstants, formatConstants, uiGridPaginationService) {
    ...
    $scope.SalesSKUbySF_Init = function () {
        ...
        $scope.Grid.Options.columnDefs = [
            ...
            //Расчет(Sell In)
            { headerTooltip: true, cellTooltip: true, enableCellEdit: false, width: 100, name: 'Расчет(Sell In)', field: 'InitialDataSellIn_Calculated', type: 'number', visible: true, nullable: true, headerCellClass: 'initialdata', filter: { condition: uiGridCustomService.numberCondition }, cellTemplate: numbercellTemplateHint },
            ...
            { headerTooltip: true, cellTooltip: true, enableCellEdit: false, width: 100, name: 'E-com цена', field: 'EcomData_AvgPrice', type: 'number', visible: true, nullable: true, headerCellClass: 'ecomdata', filter: { condition: uiGridCustomService.numberCondition } },

            //Индекс дистрибуции
            { headerTooltip: true, cellTooltip: true, enableCellEdit: false, width: 100, name: 'ИД тек.', field: 'DistributionIndex', type: 'number', visible: true, nullable: true, headerCellClass: 'di', filter: { condition: uiGridCustomService.numberCondition }, cellTemplate: numbercellTemplateHint },
            { headerTooltip: true, cellTooltip: true, enableCellEdit: false, width: 100, name: 'ИД -1', field: 'DistributionIndex_1', type: 'number', visible: true, nullable: true, headerCellClass: 'di', filter: { condition: uiGridCustomService.numberCondition }, cellTemplate: numbercellTemplateHint },
            { headerTooltip: true, cellTooltip: true, enableCellEdit: false, width: 100, name: 'ИД -2', field: 'DistributionIndex_2', type: 'number', visible: true, nullable: true, headerCellClass: 'di', filter: { condition: uiGridCustomService.numberCondition }, cellTemplate: numbercellTemplateHint },
            { headerTooltip: true, cellTooltip: true, enableCellEdit: false, width: 100, name: 'ИД -3', field: 'DistributionIndex_3', type: 'number', visible: true, nullable: true, headerCellClass: 'di', filter: { condition: uiGridCustomService.numberCondition }, cellTemplate: numbercellTemplateHint },
            ...
            { headerTooltip: true, cellTooltip: true, enableCellEdit: false, width: 150, name: 'Выручка на 1 аптеку ОФД', field: 'RevenuePerOFDpharmacy', visible: false, headerCellClass: 'Revenue', filter: { condition: uiGridCustomService.condition }, cellTemplate: numbercellTemplateHint },
            { headerTooltip: true, cellTooltip: true, enableCellEdit: false, width: 150, name: 'Выручка на 1 аптеку АЛБ', field: 'RevenuePerALBpharmacy', visible: false, headerCellClass: 'Revenue', filter: { condition: uiGridCustomService.condition }, cellTemplate: numbercellTemplateHint },
            { headerTooltip: true, cellTooltip: true, enableCellEdit: false, width: 150, name: 'Доля от рынка в регионе ОФД', field: 'MarketShareinOFDRegion', visible: false, headerCellClass: 'Revenue', filter: { condition: uiGridCustomService.condition }, cellTemplate: numbercellTemplateHint },
            { headerTooltip: true, cellTooltip: true, enableCellEdit: false, width: 150, name: 'Доля от рынка в регионе АЛБ', field: 'MarketShareinALBRegion', visible: false, headerCellClass: 'Revenue', filter: { condition: uiGridCustomService.condition }, cellTemplate: numbercellTemplateHint },
            { headerTooltip: true, cellTooltip: true, enableCellEdit: false, width: 150, name: 'Среднее арифметическое 1', field: 'RevenueAverage', visible: false, filter: { condition: uiGridCustomService.condition }, cellTemplate: numbercellTemplateHint },
            { headerTooltip: true, cellTooltip: true, enableCellEdit: false, width: 150, name: 'выбираем источник ОФД/АЛБ', field: 'ChooseSourceOFD_ALB', visible: false, filter: { condition: uiGridCustomService.condition }, cellTemplate: numbercellTemplateHint },
            { headerTooltip: true, cellTooltip: true, enableCellEdit: false, width: 150, name: 'вероятность смещения', field: 'BiasProbability', visible: false, filter: { condition: uiGridCustomService.condition }, cellTemplate: numbercellTemplateHint },
            { headerTooltip: true, cellTooltip: true, enableCellEdit: false, width: 150, name: 'Среднее кол-во уп. на фейковую часть', field: 'AverageQuantityPacktoFakePart', visible: false, headerCellClass: 'Average', filter: { condition: uiGridCustomService.condition }, cellTemplate: numbercellTemplateHint },
            { headerTooltip: true, cellTooltip: true, enableCellEdit: false, width: 150, name: 'Доля от точек ОФД', field: 'ShareOfOFDPoints', visible: false, filter: { condition: uiGridCustomService.condition }, cellTemplate: numbercellTemplateHint },
            { headerTooltip: true, cellTooltip: true, enableCellEdit: false, width: 150, name: 'Доля от точек АЛБ', field: 'ShareOfAlphaBitPoints', visible: false, headerCellClass: 'Revenue', filter: { condition: uiGridCustomService.condition }, cellTemplate: numbercellTemplateHint },
            ...
            { headerTooltip: true, cellTooltip: true, enableCellEdit: false, width: 150, name: 'Среднее кол-во точек на фейковую часть', field: 'AverageQuantityPacktoFakePart2', visible: false, headerCellClass: 'Average', filter: { condition: uiGridCustomService.condition }, cellTemplate: numbercellTemplateHint },
            { headerTooltip: true, cellTooltip: true, enableCellEdit: false, width: 150, name: 'Расчет фейковой части кол-ва аптек', field: 'CalculationOfFakePartOfNumberOfPharmacies', visible: false, headerCellClass: 'Average', filter: { condition: uiGridCustomService.condition }, cellTemplate: numbercellTemplateHint },
            { headerTooltip: true, cellTooltip: true, enableCellEdit: false, width: 150, name: 'Кол-во упаковок фейк.', field: 'NumberOfFakePacks', visible: false, headerCellClass: 'Average', filter: { condition: uiGridCustomService.condition }, cellTemplate: numbercellTemplateHint },
            { headerTooltip: true, cellTooltip: true, enableCellEdit: false, width: 150, name: 'Весь рынок', field: 'WholeMarket', visible: false, filter: { condition: uiGridCustomService.condition }, cellTemplate: numbercellTemplateHint },
            { headerTooltip: true, cellTooltip: true, enableCellEdit: false, width: 150, name: 'Прирост всего рынка от предыдущего месяца', field: 'GrowthOfEntireMarketFromPreviousMonth', visible: false, headerCellClass: 'Average', filter: { condition: uiGridCustomService.condition }, cellTemplate: numbercellTemplateHint }
        ];
