...
namespace DataAggregator.Web
{
    ...
    //https://github.com/mono/aspnetwebstack/blob/master/src/System.Web.Mvc/JsonValueProviderFactory.cs
    public sealed class CustomJsonValueProviderFactory : ValueProviderFactory
    {
        ...
        private static object GetDeserializedObject(ControllerContext controllerContext)
        {
            ...
            //increase MaxJsonLength.  This could be read in from the web.config if you prefer
